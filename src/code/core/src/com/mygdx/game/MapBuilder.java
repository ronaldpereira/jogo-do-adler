...
public class MapBuilder 
{
    ...
    public MapBuilder(int width,int height,SpriteBatch batch,final OrthographicCamera camera)
    {
        map = new CollisionMap(width,height,batch);
        this.batch = batch;
